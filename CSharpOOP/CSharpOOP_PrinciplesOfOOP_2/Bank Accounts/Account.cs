...
namespace Bank_Accounts
{
    public abstract class Account : IDepositable
    {
        ...
        // Property Months because we have to know for how many months the account has existed and to calculate after that "InterestAmount"
        public int Months
        {
            get
            {
        ...
        public void MakeDeposit(decimal amount)
        {
            if (amount <= 0)
            {
                throw new ArgumentException("You cannot deposit a negative or a zero sum!");
            }

            this.Balance += amount;
        }

        // Method virtual, because it has common case and is suppossed to be implemented by child classes
