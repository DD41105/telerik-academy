...
namespace _12.ExtractStudentsByPhone
{
    class ExtractStudentsByPhone
    {
        static void Main(string[] args)
        {
            ...
            {
                new Student("Ivan", "Ivanchev", 42412, "029815124", "pencho@gmail.com", 3),
                new Student("Dimitar", "Dimitriev", 42413, "+3598815124", "pencho@gmail.com", 2),
                new Student("Anna", "Pencheva", 42414, "025981244", "pencho@gmail.com", 1),
                new Student("Tsvetelina", "Ivanova", 42415, "+3598815124", "pencho@abv.bg", 4),
                ...
                new Student("Alexander", "Genov", 42418, "0298815124", "pencho@abv.bg", 3),
                new Student("Trifon", "Penchev", 42419, "+3598815124", "pencho@gmail.com", 2),
                new Student("Hristo", "Todorov", 424110, "+3598815124", "pencho@abv.bg", 2),
                new Student("Maria", "Pencheva", 424111, "0298815124", "pencho@gmail.com", 3),
            };
